...
data_paths = {'dgx1':
           ...
           'pretzel': {
                'brats_2021': '/data2/tom/BraTS2021',
                'brats_2021_whole': '/data2/tom/BraTS2021/whole',
                'kch_gliomas': '/data2/tom/KCHGliomas',
                'kch_gliomas_whole': '/data2/tom/KCHGliomas/whole',
                ...
                'crossmoda_orig_source': '/data2/tom/crossmoda/source_training/',
                'crossmoda_orig_source_whole': '/data2/tom/crossmoda/source_training/whole',
                'crossmoda_orig_target': '/data2/tom/crossmoda/target_training/',
                'crossmoda_orig_target_whole': '/data2/tom/crossmoda/target_training/whole',
                'crossmoda_source': '/data2/tom/crossmoda_tcia/source/',
                'crossmoda_source_whole': '/data2/tom/crossmoda_tcia/source/whole',
                'crossmoda_target': '/data2/tom/crossmoda_tcia/target/',
                'crossmoda_target_whole': '/data2/tom/crossmoda_tcia/target/whole',
